	...
	<aui:form action="${assignmentActionURL}" name="fm">
		...
		<aui:fieldset-group markupView="lexicon">
			...
			<aui:fieldset>
				...
				<aui:select label="Icon Type:" name="iconType">
				    <aui:option value="icon-book">Book</aui:option>
				    <aui:option value="icon-file-text">File</aui:option>
				    <aui:option value="icon-folder-close">Folder</aui:option>
				    <aui:option value="icon-rss">Rss</aui:option>
				    <aui:option value="icon-user">User</aui:option>
				    <aui:option value="icon-sitemap">Sitemap</aui:option>
				</aui:select>
