 ...
 public class AssignmentAssetRenderer extends BaseJSPAssetRenderer<Assignment> {
     ...
     public PortletURL getURLEdit(
         ...
         PortletURL portletURL = PortalUtil.getControlPanelPortletURL(
             liferayPortletRequest, group, AppbookPortletKeys.APPBOOK, 0, 0,
     ...
     public String getURLViewInContext(
         ...
         try {
             long plid = PortalUtil.getPlidFromPortletId(
                 _assignment.getGroupId(), AppbookPortletKeys.APPBOOK
             );
             ...
             if (plid == LayoutConstants.DEFAULT_PLID) {
                 ...
                 portletURL =
                     PortletURLFactoryUtil.getPortletURLFactory(
                         ...
                         liferayPortletRequest, AppbookPortletKeys.APPBOOK,
