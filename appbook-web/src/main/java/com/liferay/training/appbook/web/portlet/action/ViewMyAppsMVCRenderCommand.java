...
import com.liferay.training.appbook.web.config.AppbookConfiguration;
import com.liferay.training.appbook.web.constants.AppbookPortletKeys;
import com.liferay.training.appbook.web.internal.security.permission.resource.AssignmentPermission;
...
public class ViewMyAppsMVCRenderCommand implements MVCRenderCommand {
	...
	@Reference
	protected AssignmentPermission assignmentPermission;
	...
	public String render(
		...
		renderRequest.setAttribute("myAppPermission", assignmentPermission);
	...
	private void addMyAppListAttributes(RenderRequest renderRequest) {
		...
		for (JournalArticle journalArticle : journalArticles) {
			//System.out.println("Has permission: " + permissionChecker.hasPermission(groupId, "com.liferay.portlet.journal.model.JournalArticle", journalArticle.getPrimaryKey(), ActionKeys.VIEW));
