package com.liferay.training.appbook.web.display.context;
...
import com.liferay.training.appbook.web.internal.security.permission.resource.AssignmentTopLevelPermission;
    ...
    public String getDisplayStyle() {
        ...
        if (Validator.isNull(displayStyle)) {
            displayStyle = _portalPreferences.getValue(
                AppbookPortletKeys.APPBOOK, "assignments-display-style",
                "descriptive");
        }
        else {
