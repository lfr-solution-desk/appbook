...
package com.liferay.training.appbook.service.persistence.impl;
...
import com.liferay.training.appbook.exception.NoSuchAssignmentException;
import com.liferay.training.appbook.model.Assignment;
import com.liferay.training.appbook.model.impl.AssignmentImpl;
import com.liferay.training.appbook.model.impl.AssignmentModelImpl;
import com.liferay.training.appbook.service.persistence.AssignmentPersistence;
import com.liferay.training.appbook.service.persistence.impl.constants.AppbookPersistenceConstants;
...
public class AssignmentPersistenceImpl
	 ...
	 */
	@Override
	public List<Assignment> findByUserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<Assignment> findByUserId(
	 ...
	 */
	@Override
	public Assignment findByUserId_First(
			long userId, OrderByComparator<Assignment> orderByComparator)
		throws NoSuchAssignmentException {

		Assignment assignment = fetchByUserId_First(userId, orderByComparator);
	 ...
	 */
	@Override
	public Assignment fetchByUserId_First(
		long userId, OrderByComparator<Assignment> orderByComparator) {

		List<Assignment> list = findByUserId(userId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Assignment findByUserId_Last(
			long userId, OrderByComparator<Assignment> orderByComparator)
		throws NoSuchAssignmentException {

		Assignment assignment = fetchByUserId_Last(userId, orderByComparator);
	 ...
	 */
	@Override
	public Assignment fetchByUserId_Last(
		long userId, OrderByComparator<Assignment> orderByComparator) {
		...
		List<Assignment> list = findByUserId(
	 ...
	 */
	@Override
	public Assignment[] findByUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(
				session, assignment, userId, orderByComparator, true);

			array[1] = assignment;

			array[2] = getByUserId_PrevAndNext(
				session, assignment, userId, orderByComparator, false);
	...
	protected Assignment getByUserId_PrevAndNext(
		Session session, Assignment assignment, long userId,
		OrderByComparator<Assignment> orderByComparator, boolean previous) {
	...
	@Override
	@Reference(
		target = AppbookPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = AppbookPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static final String _FILTER_SQL_SELECT_ASSIGNMENT_WHERE =
		"SELECT DISTINCT {assignment.*} FROM Appbook_Assignment assignment WHERE ";

	private static final String
		_FILTER_SQL_SELECT_ASSIGNMENT_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {Appbook_Assignment.*} FROM (SELECT DISTINCT assignment.assignmentId FROM Appbook_Assignment assignment WHERE ";

	private static final String
		_FILTER_SQL_SELECT_ASSIGNMENT_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN Appbook_Assignment ON TEMP_TABLE.assignmentId = Appbook_Assignment.assignmentId";

	private static final String _FILTER_SQL_COUNT_ASSIGNMENT_WHERE =
		"SELECT COUNT(DISTINCT assignment.assignmentId) AS COUNT_VALUE FROM Appbook_Assignment assignment WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "assignment";

	private static final String _FILTER_ENTITY_TABLE = "Appbook_Assignment";

	private static final String _ORDER_BY_ENTITY_ALIAS = "assignment.";

	private static final String _ORDER_BY_ENTITY_TABLE = "Appbook_Assignment.";
